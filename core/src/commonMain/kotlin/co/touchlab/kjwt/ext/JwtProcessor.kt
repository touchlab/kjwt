 ...
 * [BaseJwsProcessor.algorithm], be of different runtime types, and neither may already be a full [JwsProcessor].
 ...
 *
 * Returns `this` unchanged when [other] is `null`. The two processors must share the same
 * [BaseJweProcessor.algorithm], be of different runtime types, and neither may already be a full [JweProcessor].
