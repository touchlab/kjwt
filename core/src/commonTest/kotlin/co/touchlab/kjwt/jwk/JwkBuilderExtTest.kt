    ...
    FunSpec({
        ...
        context("keyId propagation") {
            ...
            test("sign with HS256 JWK defaults kid to jwk.kid") {
                ...
                assertTrue(
                    headerJson.contains("\"kid\":\"my-hmac-key\""),
                    "Header must contain jwk kid, got: $headerJson"
                )
            }
            ...
            test("sign with HS256 JWK explicit keyId overrides jwk.kid") {
                ...
                val headerJson = decodeTokenHeader(token)
                assertTrue(
                    headerJson.contains("\"kid\":\"override-kid\""),
                    "Header must contain overridden kid, got: $headerJson",
                )
            }
