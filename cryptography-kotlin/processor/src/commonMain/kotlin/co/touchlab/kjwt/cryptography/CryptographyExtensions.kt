...
import co.touchlab.kjwt.model.algorithm.JwtEdCurve
...
public fun JwtEdCurve.toCryptographyKotlin(): EdDSA.Curve =
    when (this) {
        JwtEdCurve.Ed25519 -> EdDSA.Curve.Ed25519
        JwtEdCurve.Ed448 -> EdDSA.Curve.Ed448
    }
