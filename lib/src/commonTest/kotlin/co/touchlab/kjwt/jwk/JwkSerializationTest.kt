...
class JwkSerializationTest : FunSpec({
    ...
    context("RSA round-trip") {
        ...
        test("rsa public key round trip") {
            ...
            val serialized = JwtJson.encodeToString(jwk)
            ...
            val deserialized = JwtJson.decodeFromString<Jwk>(serialized)
        ...
        test("rsa private key round trip") {
            ...
            val deserialized = JwtJson.decodeFromString<Jwk>(serialized) as Jwk.Rsa
            assertEquals(jwk, deserialized)
    ...
    context("parse from RFC 7517 Appendix A examples") {
        ...
        test("RFC Appendix A1 ec public keys") {
            ...
            val jwks = JwtJson.decodeFromString<JwkSet>(jwksJson)
